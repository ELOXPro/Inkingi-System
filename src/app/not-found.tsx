...
export default function NotFound() {
  return (
    <div className='w-screen h-screen flex gap-6 items-center justify-center'>
      <Image src="/favicon.svg" alt=" Inkingi System Logo" width={50} height={50} priority />
      <div className='border-l border-secondary gap-4 flex flex-col p-2'>
      <h1 className='text-secondary text-xl animate-pulse font-bold'>Page Not Found</h1>
      <GoBack />
      </div>
    </div>
  )
